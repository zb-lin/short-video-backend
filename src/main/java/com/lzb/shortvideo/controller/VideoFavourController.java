...
public class VideoFavourController {
    ...
    public BaseResponse<Page<VideoVO>> listMyFavourVideoByPage(@RequestBody VideoFavourQueryRequest videoFavourQueryRequest,
                                                               HttpServletRequest request) {
        ...
        Page<Video> videoPage = videoFavourService.listFavourVideoByPage(new Page<>(current, size),
                videoService.getQueryWrapper(videoFavourQueryRequest.getVideoQueryRequest()), loginUser.getId());
